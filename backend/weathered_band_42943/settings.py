"""
Django settings for weathered_band_42943 project.
...
ROOT_URLCONF = 'weathered_band_42943.urls'
...
WSGI_APPLICATION = 'weathered_band_42943.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_band_42943 API",
    "DESCRIPTION": "API documentation for weathered_band_42943 App",
    "VERSION": "v1",
}
