...
## Project Structure
    ...
    ├── weathered_band_42943  # Django project configurations
...
1. Clone this repo and `cd weathered_band_42943`
...
2. Clone this repo and `cd weathered_band_42943`
